...
// Entrada de dados: idade do cliente
...
if (idade < 18) {
    ...
    if (salario < 1500) {
        ...
        if (score < 400) {
            ...
            // Decisão encadeada: limite por faixa salarial
            let limiteSalario = (salario <= 3000) ? 5000 : 15000;
            
            // Decisão encadeada: limite por faixa de score
            let limiteScore = (score <= 699) ? 5000 : 15000;
            
            // Limite final é o menor entre salário e score
            let limiteFinal = (limiteSalario < limiteScore) ? limiteSalario : limiteScore;
            
            // Decisão final de concessão do crédito
            if (valorSolicitado > limiteFinal) {
                ...
                console.log("Empréstimo aprovado com sucesso! Valor liberado: R$ " + valorSolicitado.toFixed(2));
            }
        }
    }
}
